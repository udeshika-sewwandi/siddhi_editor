 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.siddhi.siddhi.FOR#getFor <em>For</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.siddhi.siddhi.SiddhiPackage#getFOR()
 * @model
 * @generated
 */
public interface FOR extends EObject
{
   ...
   * @see #setFor(String)
   * @see org.xtext.example.siddhi.siddhi.SiddhiPackage#getFOR_For()
   * @model
   * @generated
   */
  String getFor();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.siddhi.siddhi.FOR#getFor <em>For</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
