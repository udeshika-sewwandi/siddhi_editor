 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.siddhi.siddhi.LONG#getLong <em>Long</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.siddhi.siddhi.SiddhiPackage#getLONG()
 * @model
 * @generated
 */
public interface LONG extends EObject
{
   ...
   * @see #setLong(String)
   * @see org.xtext.example.siddhi.siddhi.SiddhiPackage#getLONG_Long()
   * @model
   * @generated
   */
  String getLong();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.siddhi.siddhi.LONG#getLong <em>Long</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
