...
public class FeaturesImpl extends FeaturesOrOutAttrImpl implements Features
{
  ...
  public NotificationChain basicSetType(AttributeType newType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiddhiPackage.FEATURES__TYPE, oldType, newType);
  ...
  public void setType(AttributeType newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiddhiPackage.FEATURES__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiddhiPackage.FEATURES__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SiddhiPackage.FEATURES__TYPE, newType, newType));
  }
